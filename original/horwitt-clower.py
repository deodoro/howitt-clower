...
def run_once(run_idx, params):
    ...
    def log_progress(week):
        ...
        # if True:
            ...
            year = (week+1) // 50
            ns = len(shops)
            print(f"{part} {moneytraders:6.0f} {usingmoney[1]:6.0f} {usingmoney[2]:6.0f} {usingmoney[3]:6.0f} {usingmoney[4]:6.0f} {usingmoney[5]:6.0f} {year:6d} {ns:4d}")
...
def run_many(args):
    ...
    results=[]
    for params.s_overhead in [16, 18]:
